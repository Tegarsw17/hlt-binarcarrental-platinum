          ...
          {token && <Alert variant="success">Login Success</Alert>}
                <form>
                    <div className="form-group">
                        <label>Email</label>
                        <input onChange={handleOnChange} name="email"  type="email" placeholder="Contoh: johndee@gmail.com" className="form-control" />
                    </div>
                    <div className="form-group">
                        <label>Password</label>
                        <input onChange={handleOnChange} name="password" type="password" placeholder="6+ karakter" className="form-control" />
                    </div>
